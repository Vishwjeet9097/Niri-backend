...
export class InitialMigration1761383950366 implements MigrationInterface {
    name = 'InitialMigration1761383950366'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "final_scores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "submission_id" uuid NOT NULL, "state_ut" character varying NOT NULL, "total_score" numeric(10,2) NOT NULL, "percentage" numeric(5,2), "score_breakdown" jsonb NOT NULL, "calculation_methodology" text NOT NULL, "approved_by" character varying NOT NULL, "category_scores" jsonb, "scoring_version" character varying NOT NULL DEFAULT '2.0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_ca086d60022bb24faa3d5b0e41" UNIQUE ("submission_id"), CONSTRAINT "PK_526010129df3c6668c0558cc8b2" PRIMARY KEY ("id"))`);
