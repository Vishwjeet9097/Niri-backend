...
export class MigrationName1767088382939 implements MigrationInterface {
    name = 'MigrationName1767088382939'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ministry_input_fields_data_type_enum" AS ENUM('number', 'file', 'string', 'dropdown')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ministry_input_fields_data_type_enum_old" AS ENUM('number', 'file', 'string')`);
        await queryRunner.query(`ALTER TABLE "ministry_input_fields" ALTER COLUMN "data_type" DROP DEFAULT`);
