...
export class InitMigration1765800488172 implements MigrationInterface {
    name = 'InitMigration1765800488172'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."ulb_masters_status_enum" AS ENUM('0', '1')`);
