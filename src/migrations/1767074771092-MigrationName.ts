...
export class MigrationName1767074771092 implements MigrationInterface {
    name = 'MigrationName1767074771092'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ministry_form" ADD "ministry_user" character varying(255)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ministry_form" DROP COLUMN "ministry_user"`);
    }
