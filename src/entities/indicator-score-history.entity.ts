...
@Entity('indicator_score_history')
@Index(['submissionId', 'indicatorCode'])
@Index(['submissionId'])
@Index(['indicatorCode'])
@Index(['createdAt'])
export class IndicatorScoreHistory {
  ...
  indicatorStatus: string | null; // Status at time of update (e.g., "SUBMITTED_TO_STATE", "RESUBMITTED")
