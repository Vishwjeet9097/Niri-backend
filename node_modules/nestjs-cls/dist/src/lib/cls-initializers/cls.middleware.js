...
let ClsMiddleware = class ClsMiddleware {
    constructor(options) {
            ...
            const callback = async () => {
                ...
                try {
                    ...
                    if (this.options.generateId) {
                        const id = await ((_b = (_a = this.options).idGenerator) === null || _b === void 0 ? void 0 : _b.call(_a, req));
        ...
        this.options = Object.assign(Object.assign({}, new cls_options_1.ClsMiddlewareOptions()), options);
    }
};
ClsMiddleware = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(cls_constants_1.CLS_MIDDLEWARE_OPTIONS)),
