...
export type ClsModuleProxyProviderOptions = ClsModuleProxyClassProviderOptions | ClsModuleProxyFactoryProviderOptions;
...
export {};
//# sourceMappingURL=proxy-provider.interfaces.d.ts.map